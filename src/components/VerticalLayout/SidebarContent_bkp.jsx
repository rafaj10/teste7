          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/#" className="has-arrow">
                ...
                <span>{props.t("Dashboards")}</span>111
              </Link>
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/inicio">{props.t("Default")}</Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                <li>
                  <Link to="/importar-leads">{props.t("Create New")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                <li>
                  <Link to="/funil">{props.t("Tasks Kanban")}</Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/dashboards">{props.t("Apex charts")}</Link>
                </li>
                <li>
