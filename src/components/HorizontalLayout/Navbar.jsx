            ...
            >
              <ul className="navbar-nav">
                <li className="nav-item dropdown">
                  ...
                  >
                    <Link to="/inicio" className="dropdown-item">
                      {props.t('Default')}
                    </Link>
                ...
                <li className="nav-item dropdown">
                  ...
                  <div className={classname('dropdown-menu', { show: app })}>
                    <Link to="/agenda" className="dropdown-item">
                      {props.t('Calendar')}
                    </Link>
                    ...
                    <div className="dropdown">
                      ...
                      >
                        ...
                        <Link to="/importar-leads" className="dropdown-item">
                          {props.t('Create New')}
                        </Link>
                      </div>
                    </div>
                    <div className="dropdown">
                      ...
                      >
                        ...
                        <Link to="/funil" className="dropdown-item">
                          {props.t('Tasks Kanban')}
                        </Link>
                        <Link to="/criar-cadencia" className="dropdown-item">
                          {props.t('Create Task')}
                        </Link>
                      </div>
                    </div>
                    <div className="dropdown">
                      ...
                      >
                        ...
                        <Link to="/empresas" className="dropdown-item">
                          {props.t('User List')}
                        </Link>
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    <div className="dropdown">
                      ...
                      >
                        <Link to="/dashboards" className="dropdown-item">
                          {' '}
                          {props.t('Apex charts')}
                        </Link>
