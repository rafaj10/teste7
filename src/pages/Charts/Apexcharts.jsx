...
const Apexchart = () => {
  //meta title
  document.title = 'Meu Dashboar | 7Stratos'
        ...
        <div className="container-fluid">
          ...
          <Row>
            <Col lg={6}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4">Curva de Leads</CardTitle>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4">Conversão mensal</CardTitle>
          ...
          <Row>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  <CardTitle className="mb-4"> Por SDR </CardTitle>
