...
const ForgetPasswordPage = (props) => {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      email: Yup.string().required("Por favor preenche o teu e-mail"),
    }),
    onSubmit: (values) => {
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={5}>
                  ...
                  <Row>
                    <Col xs={7}>
                      <div className="text-primary p-4">
                        ...
                        <p>Coloque teu e-mail abaixo e vamos recuperar a sua senha.</p>
                      </div>
                    </Col>
                    ...
                    >
                      <div className="mb-3">
                        ...
                        <Input
                          ...
                          placeholder="Preencha o teu email"
                          type="email"
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  © {new Date().getFullYear()} 7Stratos. Feito com{" "} 
